...
contract S5Pool is ERC20, Ownable {
    ...
    function calculateFee(uint256 amount) public pure returns (uint256) {
        ...
        function getPoolTokenBalances2() external view returns (uint256, uint256, uint256) {
            uint256 balanceA = i_tokenA.balanceOf(address(this));
            uint256 balanceB = i_tokenB.balanceOf(address(this));
            uint256 balanceC = i_tokenC.balanceOf(address(this));
